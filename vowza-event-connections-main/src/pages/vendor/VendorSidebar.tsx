        ...
        {NAV_ITEMS.map(item => {
          ...
          return (
            <NavLink
              ...
              title={collapsed ? (item.to === '/vendor/packages' && isWaterSupplier(provider) ? 'Water Products' : item.label) : undefined}
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {!collapsed && (
                    <>
                      <span className="truncate">{item.to === '/vendor/packages' && isWaterSupplier(provider) ? 'Water Products' : item.label}</span>
                      {count > 0 && (

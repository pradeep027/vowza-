...
const Auth = () => {
  ...
  const { signIn, signUp, signInWithGoogle, user, roles, rolesLoaded } = useAuth();
      ...
      {showResetForm ? (
        ...
        <div>
          ...
          <button
            ...
            disabled={isLoading}
            className="mb-4 w-full rounded-xl border border-slate-200 dark:border-border bg-white dark:bg-surface-1 px-4 py-3 text-sm font-semibold text-foreground shadow-sm transition-colors hover:bg-slate-50 dark:hover:bg-surface-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-60"
          >

-- ============================================
-- EVENT MARKETPLACE MIGRATION - CORRECTED
-- Multi-artist booking, event planning, team builder
-- Compatible with existing FINAL_MIGRATION_V3.sql schema
-- ============================================
...
-- ============================================
-- Note: update_updated_at_column() function exists in FINAL_MIGRATION_V3.sql
-- This function is already defined and will be reused
...
AND routine_name IN ('create_event_booking', 'add_artist_to_event', 'update_artist_booking_status');
